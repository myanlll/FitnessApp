...
class Ui_planlama(object):
    def setupUi(self, Form):
        ...
        self.line_konut_id = QLineEdit(self.verticalLayoutWidget_2)
        self.line_konut_id.setObjectName(u"line_konut_id")
        self.line_konut_id.setEnabled(False)

        self.horizontalLayout_16.addWidget(self.line_konut_id)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_16.setText(QCoreApplication.translate("Form", u"Konut ID", None))
        self.label_17.setText(QCoreApplication.translate("Form", u"Konut T\u00fcr\u00fc", None))
        self.label_20.setText(QCoreApplication.translate("Form", u"Mersis No", None))
        self.label_22.setText(QCoreApplication.translate("Form", u"Havuz", None))
        self.label_18.setText(QCoreApplication.translate("Form", u"Alan", None))
